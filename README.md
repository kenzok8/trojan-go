# Trojan-Go [![Go Report Card](https://goreportcard.com/badge/github.com/kenzok8/trojan-go)](https://goreportcard.com/report/github.com/kenzok8/trojan-go) [![Downloads](https://img.shields.io/github/downloads/kenzok8/trojan-go/total?label=downloads&logo=github&style=flat-square)](https://img.shields.io/github/downloads/kenzok8/trojan-go/total?label=downloads&logo=github&style=flat-square)
...
预编译二进制可执行文件可在 [Release 页面](https://github.com/kenzok8/trojan-go/releases)下载。解压后即可直接运行，无其他组件依赖。

如遇到配置和使用问题、发现 bug，或是有更好的想法，欢迎加入 [Telegram 交流反馈群](https://t.me/trojan_go_chat)。

## 简介

**完整介绍和配置教程，参见 [Trojan-Go 文档](https://github.com/kenzok8/trojan-go/tree/master/docs)。**
...
- [Igniter-Go](https://github.com/kenzok8/trojan-go-android)：Android 客户端，Fork 自 Igniter，将 Igniter 核心替换为 Trojan-Go 并做了一定修改，支持所有 Trojan-Go 扩展特性。
...
完整的 tag 说明参见 [Trojan-Go 文档](https://github.com/kenzok8/trojan-go/tree/master/docs)。

### 易用

配置文件格式与原版 Trojan 兼容，但做了大幅简化，未指定的字段会被赋予默认值，由此可以更方便地部署服务端和客户端。以下是一个简单例子，完整的配置文件可以参见[这里](https://github.com/kenzok8/trojan-go/tree/master/docs)。
...
完整的选项说明参见 [Trojan-Go 文档](https://github.com/kenzok8/trojan-go/tree/master/docs)。
...
只需开启客户端 mux 配置即可，服务端会自动检测是否启用多路复用并提供支持。完整的选项说明参见 [Trojan-Go 文档](https://github.com/kenzok8/trojan-go/tree/master/docs)。
...
```shell
git clone https://github.com/kenzok8/trojan-go.git
cd trojan-go
make
...
[![Stargazers over time](https://starchart.cc/kenzok8/trojan-go.svg)](https://starchart.cc/kenzok8/trojan-go)
